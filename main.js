...
let Name = ["Anumta", "Madiha", "Laiba", "Kainat"];
console.log(Name[(0)]);
console.log(Name[(1)]);
console.log(Name[(2)]);
console.log(Name[(3)]);
...
let Name = ["Anumta", "Madiha", "Laiba", "Kainat"];
let message = ",would you like to come for dinner tonight ?";
...
let GUEST = ["Anumta", "Madiha", "Kainat"];
...
let places = ['Canada', 'Saudi Arabia', 'America', 'Turkey', 'Spain'];
...
let var1 = "rubasha khan";
let var2 = "rubasha khan";
if (var1 == var2) {
...
let num3 = 10;
if (num == num2) {
    console.log(num, "is euqal to", num2);
}
else {
    console.log(num, "is not euqal to", num2);
}
if (num != num2) {
    console.log(num, "is not euqal to", num2);
}
...
if (num <= num3) {
    console.log(num, "is less then", num3);
}
if (num == 6 && num1 == 3) {
...
let array = ["Blue", "Green", "pink", "Red"];
if (array.includes("pink")) {
    console.log("pink is in the array");
}
// // • Test whether an item is not in a array
if (!array.includes("purple")) {
    console.log("purple is not  in the array");
}
// Task 25
...
if (alian_Color == "Green") {
    ...
    console.log("You have earned 15 point");
}
// // Task 28
let age = 76;
if (age < 2) {
    ...
    console.log("person is a teeager");
}
else if (age < 65) {
...
// // Task 29
let favorite_fruits = ["Mango", "Apple", "Cherry", "strewberry", "Banana"];
if (favorite_fruits.includes("Apple")) {
    console.log("I really likes Apples");
}
if (favorite_fruits.includes("Mango")) {
    console.log("I really likes Mangos");
}
if (favorite_fruits.includes("Cherry")) {
    console.log("I really likes Cherrys");
}
if (favorite_fruits.includes("strewberry")) {
    console.log("I really like strewberries!");
}
if (favorite_fruits.includes("Banana")) {
    console.log("I really like bananas!");
}
// Task 30
let users = ["Admin", "Alia", "Maryam", "kainat", "Madiha"];
...
// Task 32 
let current_users = ["Bisma", "Alia", "Maryam", "kainat", "Madiha"];
let new_users = ["Bisma", "Neha", "Maryam", "Anumta", "Laiba"];
...
for (let new_user of new_users)
    if (current_Users_lower.includes(new_user.toLocaleLowerCase()))
        (console.log(` ${new_user} name ist available!`));
    else
...
// Task 36
function makeShirt(size, text) { console.log(`you order a ${size} shirt that says ${text}`); }
makeShirt('Extra small', '" I love Pakistan."');
// Task 37
function makeShirt(size = 'lagre', text = 'I love typescript !') { console.log(`You order a ${size} shirt that says ${text}`); }
makeShirt();
makeShirt('medium');
...
// Task 39
function city_country(city, country) { console.log(`${city}, ${country}.`); }
...
console.log(album);
// Task 41
function show_magicians(megicians_name) {
    for (let megician of megicians_name) {
        console.log(megician.charAt(0).toUpperCase() + megician.slice(1));
    }
}
let magician = ['Ali', 'Ahmed', 'Mustafa'];
show_magicians(magician);
// // // Task 42
function make_great(megicians_name) { for (let i = 0; i < megicians_name.length; ++i) {
    megicians_name[i] = megicians_name[i] + " the great ";
} }
const magicians = ['Ali', 'Ahmed', 'Mustafa'];
...
function make_great2(megicians_name) {
    const greatMagician = [];
    for (let i = 0; i < megicians_name.length; ++i) {
        greatMagician.push(megicians_name[i] + " The great ");
    }
    return greatMagician;
}
const magicians = ['Ali', 'Ahmed', 'Mustafa'];
const great_magician = make_great2(magicians);
show_magicians(magicians);
...
function CarOrder(manufacture, model, optional) {
    return Object.assign({ manufacture,
        model }, optional);
}
const mycar = CarOrder("Honda", "vitz", { color: "pink", year: "2020" });
console.log(mycar);
